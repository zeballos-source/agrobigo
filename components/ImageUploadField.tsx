    ...
    <div>
      ...
      {slotsLeft > 0 ? (
        <>
          {capture ? (
            <>
              <input ref={filesInputRef} type="file" name="images" accept="image/*" multiple style={{ display: "none" }} />
              <input
                ref={cameraInputRef}
                type="file"
                accept="image/*"
            ...
            <input ref={filesInputRef} type="file" name="images" accept="image/*" multiple onChange={handleFileChange} />
          )}
